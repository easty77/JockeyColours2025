...
import ene.eneform.mero.tartan.ENETartanColour;
...
public class ENETartanUtils {
	...
	public static String spaceify(String s) {
        ...
        public static void generateSVGTartanElement(Document document, Element defs, ene.eneform.mero.tartan.ENETartan tartan)
        {
        ...
        public static void generateSVGTartanElement(SVGGraphics2D svgGenerator, Element defs, ene.eneform.mero.tartan.ENETartan tartan)
        {
