...
public class BasicRace implements BasicRaceInfo {
    ...
    String getFormattedDistance(int nDistanceYards, boolean bAbbrev, boolean bYards, boolean bHTML)
    {
    ...
    String getAbbreviatedTitle(String strTitle)
    {
    ...
    String removeSponsor(String strRaceTitle)
    {
    ...
    String replaceSponsorString(String strRaceTitle)
    {
        String[] astrReplace ={"William Hill", "John Smith's", "Keith Prowse Hospitality", "Coral-", "Crabbie's", "Racing Uk On Virgin 536", "Cathay Pacific",
                ...
                "Merewood Homes", "Merewood Group", "HBLB", "Quantel", "Grangewood", "JPMorgan Bank", "JPMorgan", "J. P. Morgan", "Weatherbys Insurance",
